...
import {
  ...
  removeGrlSStyleNode,
} from './modules/stylesHelpers/appliedGrlScreenStyles.js'
import { generateRandomColor } from './modules/helpers/generateRandColor.js'
import { isInvalidEleToShow } from './modules/validators/isValidEleToShow.js'
import { alertMe } from './modules/alert.js'
import { lockBtn } from './modules/helpers/lockBtn.js'
import {
  appliedMdSStylesShower,
  removeMdSStyleNode,
} from './modules/stylesHelpers/appliedMdScreenStyles.js'
import {
  appliedLgSStylesShower,
  removeLgSStyleNode,
} from './modules/stylesHelpers/appliedLgScreenStyles.js'
...
function selectNode(e, id) {
  ...
  getNode('.applied-styles').innerHTML = ''
  appliedGrlSStylesShower(id)
  appliedMdSStylesShower(id)
  appliedLgSStylesShower(id)
...
function selectAppNode() {
  ...
  getNode('.applied-styles').innerHTML = ''
  appliedGrlSStylesShower('#app')
  appliedMdSStylesShower('#app')
  appliedLgSStylesShower('#app')
  getNode('#edit_form')?.remove()
}
